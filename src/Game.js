...
class Game extends Component {
    ...
    upgradeHandler(e) {
        ...
        if (type === 'looter') {
            ...
            definition = this.SPECIAL_TYPES[id];
        } else {
            throw new TypeError("You can only upgrade looters, defenders, and specials every now and then.");
        }
        ...
        if (this.state.loot >= definition['cost']) {
            ...
            if (type === 'looter') {
                ...
                newState['immunity'] += definition['immunity'];
            }
    ...
    updateGame() {
        ...
        if (this.state.wave.secondsUntil <= 0) {
            ...
            this.setState({
                ...
                immunity: this.state.immunity - 1,
            })
